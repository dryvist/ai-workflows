...
// OpenRouter's endpoint-ZDR field name is NOT verified against a live response
// (no network access from here) — this checks every plausible shape and
// returns 'unknown' rather than guessing, since a false PASS is the exact
// failure mode (a delisted ZDR provider) this exists to catch.
