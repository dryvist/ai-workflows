...
| `policy-gate.yml` | `workflow_call` | On PR (consumer) | Cheap model scores the diff against a fixed rubric (DRY, native-first, disclosure, missing-test, token-budget); advisory sticky comment |
