...
jobs:
  ...
  review:
    ...
    uses: dryvist/ai-workflows/.github/workflows/post-merge-tests.yml@v0
    with:
...
jobs:
  ...
  resolve-issue:
    ...
    uses: dryvist/ai-workflows/.github/workflows/issue-resolver.yml@<version>
    secrets: inherit
    with:
...
jobs:
  link-issues:
    ...
    uses: dryvist/ai-workflows/.github/workflows/issue-linker.yml@v0
    secrets: inherit
```
...
jobs:
  notify:
    uses: dryvist/ai-workflows/.github/workflows/notify-ai-pr.yml@v0
    secrets: inherit
```
